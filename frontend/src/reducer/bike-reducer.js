...
export const postUserDataReducer = (state = { postUserData: {} },{type,payload}) => {
     switch (type) {
         case POST_USER_BIKE_REQUEST: return {postUserData:{},isloading:true}
         case POST_USER_BIKE_SUCCESS : return{postUserData:payload,isloading:false}
         case POST_USER_BIKE_FAIL: return { postUserDataError: payload, isloading: false }
         default:
             return state
     }
}
...
export const findPostUserDataReducer = (state = { findPostUserData: [] },{type,payload}) => {
     switch (type) {
         case FIND_POST_USER_BIKE_REQUEST: return {findPostUserData: [],isloading:true}
         case FIND_POST_USER_BIKE_SUCCESS : return{findPostUserData:payload,isloading:false}
         case FIND_POST_USER_BIKE_FAIL: return { findPostUserDataError:payload, isloading: false }
         default:
             return state
     }
}
